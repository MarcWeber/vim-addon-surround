...
function! vim_addon_surround#SurroundText(left, right, map_mode)
  let g:left=a:left
  let g:right=a:right
  "if a:map_mode == 'i'
...
function! vim_addon_surround#Surround(map_mode)
  let pair = s:GetPairFromKeyboard()
  call vim_addon_surround#SurroundText(pair[0],pair[1],a:map_mode)
endfunction

function! vim_addon_surround#SubstituteSurroundingText(subst, replace_with)
  " escape [
...
function! vim_addon_surround#SubstituteSurrounding()
  let subst = s:GetPairFromKeyboard()
  let replace_with = s:GetPairFromKeyboard()
  call vim_addon_surround#SubstituteSurroundingText(subst, replace_with)
endfunction
...
function! vim_addon_surround#SubstituteInnerMostSurrounding()
  let subst = s:GetMostInnerSurrounding()
  let replace_with = s:GetPairFromKeyboard()
  call vim_addon_surround#SubstituteSurroundingText(subst, replace_with)
endfunction

function! vim_addon_surround#RemoveSurrounding()
  let subst = s:GetPairFromKeyboard()
  let g:s = subst
  let replace_with = ["",""]
  call vim_addon_surround#SubstituteSurroundingText(subst, replace_with)
...
function! vim_addon_surround#RemoveInnerMostSurrounding()
  let subst = s:GetMostInnerSurrounding()
  let replace_with = ["",""]
  call vim_addon_surround#SubstituteSurroundingText(subst, replace_with)
endfunction
